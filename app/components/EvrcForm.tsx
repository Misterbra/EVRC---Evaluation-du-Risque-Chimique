...
const EvrcForm = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-semibold text-gray-800">Sélection du produit</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-2">
            <h4 className="text-base font-semibold text-gray-700 mb-2">Catégorie de produit</h4>
            <CategorySelect 
          ...
          <div className="lg:col-span-3">
            <h4 className="text-base font-semibold text-gray-700 mb-2">Produit chimique</h4>
            <ProductSelect 
          ...
          {selectedProduct && (
            <>
              ...
              <div className="lg:col-span-5">
                <h4 className="text-base font-semibold text-gray-700 mb-2">Utilisation</h4>
                <Input
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              <h4 className="text-base font-semibold text-gray-700 mb-2">Durée/jour</h4>
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-between">
                    {formData.duration ? 
            ...
            <div>
              <h4 className="text-base font-semibold text-gray-700 mb-2">Fréquence</h4>
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-between">
                    {formData.frequency ? 
